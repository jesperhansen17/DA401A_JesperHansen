...
public class MovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        summaryView.setText(MovieListFragment.mMovieList.get(getShownIndex()).getSummary());
        imageView.setImageDrawable(MovieListFragment.mMovieList.get(getShownIndex()).getFanart());
        titleView.setText(MovieListFragment.mMovieList.get(getShownIndex()).getTitle() + "\n" + MovieListFragment.mMovieList.get(getShownIndex()).getYear());
